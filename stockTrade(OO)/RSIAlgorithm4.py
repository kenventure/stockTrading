...
class RSIAlgorithm4(Algorithm):
    ...
    def trade(self, price):
        ...
        if self.buyCondition is True and self.currTime > 14:
            self.buyCondition is False
        if self.sellCondition is True and self.currTime > 14:
    ...
    def isBuy(self, price):
        ...
        if self.isOpen is False:
            if self.buyCondition is False and self.RSI > self.B_RSILevel and diff < 15 :
            ...
            if self.bought is False and self.RSI< self.buyRSI or self.RSI > self.buyStopRSI:
                self.isOpen = False
                self.sellCondition = False
                self.bought = True
                return True
    ...
    def isSell(self, price):
        ...
        if self.isOpen is True:
            ...
            if (self.RSI > self.sellRSI or self.RSI < self.stopRSI) :
                #self.sellPrice=9999
                self.buyCondition = False
                #self.stopPrice=0
                self.isOpen  = False
            ...
            if self.sellCondition is True and self.RSI < self.S_RSILevel and diff < 15 :
