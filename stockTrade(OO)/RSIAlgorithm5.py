    ...
    def isBuy(self, price):
        ...
        if self.currTime > 15:
            if self.isOpen is False:
                if (self.buyCondition is True) and (self.RSI > self.B_RSILevel):
                ...
                if (self.position == -1) and ((self.RSI< self.buyRSI) or (self.RSI > self.buyStopRSI)):
    ...
    def isSell(self, price):
        ...
        if self.currTime>15:
            if self.isOpen is True and self.position == 1:
                ...
                if (self.sellCondition is True) and (self.RSI < self.S_RSILevel):
                    print ('Sell Short')
                    self.sellCondition  = False
                    self.bought = False
                    self.isOpen = True
