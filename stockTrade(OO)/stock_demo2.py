...
passwordCAT = "CST-"+r.headers['CST']+"|"+"XST-"+r.headers['X-SECURITY-TOKEN']
#endpoint=r.text['lightstreamerEndpoint']
# lightstreamer_client = LSClient("http://localhost:8080", "DEMO")
#lightstreamer_client = LSClient("http://push.lightstreamer.com", "DEMO")
lightstreamer_client = LSClient("https://demo-apd.marketdatasystems.com", "DEFAULT", user="lthams", password=passwordCAT)
#lightstreamer_client = LSClient("https://demo-apd.marketdatasystems.com/lightstreamer/create_session.txt", "DEFAULT", user="lthams", password=passwordCAT)
#lightstreamer_client = LSClient(endpoint, "DEFAULT", user="lthams", password=passwordCAT)
try:
