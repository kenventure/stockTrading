...
#lightstreamer_client = LSClient("http://demo-apd.marketdatasystems.com", "DEFAULT", user="lthams", password="1q2w3e4rT")
lightstreamer_client = LSClient("https://demo-apd.marketdatasystems.com/lightstreamer/create_session.txt", "DEFAULT", user="lthams", password="1q2w3e4rT")
try:
